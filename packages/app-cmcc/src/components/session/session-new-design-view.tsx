...
import brandMark from "@/assets/home-v6/brand-mark.svg"
import background from "@/assets/home-v6/background.svg"
import robotSheet from "@/assets/home-v6/robot-sheet.webp"
import capabilityResearch from "@/assets/home-v6/capability-research.svg"
import capabilityFinance from "@/assets/home-v6/capability-finance.svg"
import capabilityPhoto from "@/assets/home-v6/capability-photo.svg"
import capabilityNews from "@/assets/home-v6/capability-news.svg"
...
export function NewSessionDesignView(props: { children: JSX.Element }) {
  return (
    <div data-component="session-new-design" class="relative size-full overflow-y-auto bg-white">
      ...
      <div class="relative mx-auto flex min-h-[900px] w-[calc(100%_-_48px)] max-w-[1046px] flex-col pb-10 pt-[132px]">
        <div class="flex flex-col items-center">
          <div class="flex items-center gap-[26px]">
            ...
            <h1 class="bg-[linear-gradient(90deg,#8800ff_0%,#2c5dff_100%)] bg-clip-text text-[48px] font-medium leading-[1] text-transparent">
              DeepInsight深度洞察
            </h1>
          </div>
        ...
        <div class={`relative mx-auto mt-[117px] ${NEW_SESSION_CONTENT_WIDTH}`}>
