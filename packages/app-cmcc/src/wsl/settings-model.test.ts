...
describe("WSL server settings presentation", () => {
  ...
  test("offers install and update only when DeepInsight needs attention", () => {
  ...
  test("probes the selected distro before entering the DeepInsight step", async () => {
    const calls: string[] = []
