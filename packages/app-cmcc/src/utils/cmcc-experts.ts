...
export const CMCC_EXPERTS: CmccExpert[] = [
  {
    ...
    members: [
      { id: "deepinsight/deepinsight-team-lead", name: "阿全", profession: "研究主编", role: "lead" },
      { id: "deepinsight/di-intent-analyst", name: "阿辨", profession: "安全与需求分析师" },
      { id: "deepinsight/di-query-planner", name: "阿谋", profession: "研究规划专家" },
      { id: "deepinsight/di-local-researcher", name: "阿掘", profession: "材料研究专家" },
      { id: "deepinsight/di-web-researcher", name: "阿览", profession: "公开信息研究专家" },
      { id: "deepinsight/di-reflector", name: "阿省", profession: "证据反思专家" },
      { id: "deepinsight/di-outline-architect", name: "阿构", profession: "大纲架构专家" },
      { id: "deepinsight/di-report-writer", name: "阿据", profession: "证据型写作专家" },
      { id: "deepinsight/di-evidence-reviewer", name: "阿核", profession: "独立证据核验专家" },
      { id: "deepinsight/di-viz", name: "阿显", profession: "证据型可视化专家" },
      { id: "deepinsight/di-publisher", name: "阿稿", profession: "发布工程师" },
    ],
  },
  {
    kind: "external",
  ...
  },
  {
    kind: "team",
    id: "deepgeo",
    name: "DeepGeo 位置决策专家团",
    description:
      "把位置、客流、客群、商业和经营数据转化为可复算、可审查的位置决策报告，十二位专家协同交付，覆盖商业选址、景区及场所经营优化。",
    leadAgent: "deepgeo/deepgeo-team-lead",
    defaultPrompt: "我需要评估几个候选位置的选址可行性，请帮我分析客流、客群、商业环境和投资回报",
    tags: ["位置智能", "商业选址", "空间分析"],
    examples: [
      "我需要评估几个候选位置的选址可行性，请帮我分析客流、客群、商业环境和投资回报",
      "分析某个商圈的客流规律和客群画像，给出经营优化建议",
      "对比多个候选点位，输出一份投资决策报告",
    ],
    members: [
      { id: "deepgeo/deepgeo-team-lead", name: "阿久", profession: "首席位置决策专家", role: "lead" },
      { id: "deepgeo/dg-task-governor", name: "阿甘", profession: "任务与治理专家" },
      { id: "deepgeo/dg-data-steward", name: "阿实", profession: "数据治理与质量专家" },
      { id: "deepgeo/dg-location-analyst", name: "阿流", profession: "位置流动与可达性专家" },
      { id: "deepgeo/dg-audience-analyst", name: "阿知", profession: "客群与需求洞察专家" },
      { id: "deepgeo/dg-commercial-ecology", name: "阿态", profession: "空间商业生态专家" },
      { id: "deepgeo/dg-market-researcher", name: "阿研", profession: "行业与竞品研究专家" },
      { id: "deepgeo/dg-decision-modeler", name: "阿衡", profession: "跨领域决策模型专家" },
      { id: "deepgeo/dg-business-strategist", name: "阿算", profession: "场景经营决策专家" },
      { id: "deepgeo/dg-decision-synthesizer", name: "阿综", profession: "综合决策专家" },
      { id: "deepgeo/dg-report-editor", name: "阿读", profession: "报告与可视化总编" },
      { id: "deepgeo/dg-independent-reviewer", name: "阿审", profession: "独立质量审查专家" },
    ],
  },
  {
    kind: "team",
