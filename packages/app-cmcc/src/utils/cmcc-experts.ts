...
export const CMCC_EXPERTS: CmccExpert[] = [
  ...
  },
  {
    ...
    members: [
      ...
      { id: "ai-for-science-team/as-intent-router", name: "明达意", profession: "科研需求识别专家" },
      { id: "ai-for-science-team/as-asset-auditor", name: "简清册", profession: "科研资产审计专家" },
      { id: "ai-for-science-team/as-feasibility-advisor", name: "康可行", profession: "科研可行性顾问" },
      { id: "ai-for-science-team/as-research-planner", name: "展宏图", profession: "研究规划专家" },
      { id: "ai-for-science-team/as-literature-strategist", name: "苏寻径", profession: "文献检索策略专家" },
      { id: "ai-for-science-team/as-literature-researcher", name: "罗文瀚", profession: "论文发现专家" },
      { id: "ai-for-science-team/as-paper-evidence-analyst", name: "沈读真", profession: "论文证据分析专家" },
      { id: "ai-for-science-team/as-research-synthesizer", name: "容百川", profession: "研究综合专家" },
      { id: "ai-for-science-team/as-methodology-designer", name: "方立证", profession: "方法论设计专家" },
      { id: "ai-for-science-team/as-experiment-designer", name: "周密计", profession: "实验设计专家" },
      { id: "ai-for-science-team/as-code-data-engineer", name: "程可靠", profession: "科研代码工程专家" },
      { id: "ai-for-science-team/as-experiment-operator", name: "池行健", profession: "实验执行专家" },
      { id: "ai-for-science-team/as-experiment-diagnostician", name: "甄查因", profession: "实验诊断专家" },
      { id: "ai-for-science-team/as-result-analyst", name: "白析明", profession: "结果分析专家" },
      { id: "ai-for-science-team/as-outline-architect", name: "章有序", profession: "论证大纲专家" },
      { id: "ai-for-science-team/as-evidence-writer", name: "文有据", profession: "证据写作专家" },
      { id: "ai-for-science-team/as-figure-citation-editor", name: "修文图", profession: "图表引用编辑专家" },
      { id: "ai-for-science-team/as-independent-reviewer", name: "严把关", profession: "独立审稿专家" },
      { id: "ai-for-science-team/as-quality-citation-auditor", name: "宋真凭", profession: "引用审计专家" },
      { id: "ai-for-science-team/as-research-package-curator", name: "郭归真", profession: "研究包归档专家" },
    ],
  },
]
