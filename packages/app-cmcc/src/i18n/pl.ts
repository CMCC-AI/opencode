export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez DeepInsight",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w DeepInsight.",
  ...
  "provider.connect.opencodeZen.line1":
    "DeepInsight Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w DeepInsight.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w DeepInsight.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w deepinsight.json",
  ...
  "dialog.server.description": "Przełącz serwer DeepInsight, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja DeepInsight ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu DeepInsight",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (deepinsight.json) nazwy dostawców/modeli",
  ...
  "sidebar.gettingStarted.line1": "DeepInsight zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla DeepInsight",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd DeepInsight na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy DeepInsight ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw DeepInsight.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania DeepInsight",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji DeepInsight.",
