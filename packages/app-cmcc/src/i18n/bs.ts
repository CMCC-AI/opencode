export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje DeepInsight",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u DeepInsight-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "DeepInsight Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u DeepInsight-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u DeepInsight-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u deepinsight.json",
  ...
  "dialog.server.description": "Promijeni na koji se DeepInsight server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija DeepInsight-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku DeepInsight timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (deepinsight.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: DeepInsight još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "DeepInsight uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni DeepInsight server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u DeepInsight-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako DeepInsight izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li DeepInsight prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu DeepInsight-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se DeepInsight pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju DeepInsight-a.",
