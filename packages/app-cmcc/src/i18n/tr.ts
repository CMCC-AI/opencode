...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "DeepInsight tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve DeepInsight'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "DeepInsight Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve DeepInsight'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak DeepInsight'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler deepinsight.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi DeepInsight sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "DeepInsight'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı DeepInsight ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (deepinsight.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: DeepInsight henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "DeepInsight ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "DeepInsight Masaüstü",
  ...
  "settings.desktop.wsl.description": "DeepInsight sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "DeepInsight'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "DeepInsight'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "DeepInsight'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "DeepInsight'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "DeepInsight başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "DeepInsight'un en son sürümünü kullanıyorsunuz.",
