export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af DeepInsight",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i DeepInsight.",
  ...
  "provider.connect.opencodeZen.line1":
    "DeepInsight Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i DeepInsight.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i DeepInsight.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i deepinsight.json",
  ...
  "dialog.server.description": "Skift hvilken DeepInsight-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af DeepInsight ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til DeepInsight-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (deepinsight.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, DeepInsight understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "DeepInsight inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør DeepInsight-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for DeepInsight",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan DeepInsight ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om DeepInsight følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan DeepInsight er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når DeepInsight starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af DeepInsight.",
