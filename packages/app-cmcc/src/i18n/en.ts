export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by DeepInsight",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in DeepInsight.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "DeepInsight Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.opencodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.opencodeZen.visit.prefix": "Visit ",
  "provider.connect.opencodeZen.visit.link": "deepinsight.ai/zen",
  "provider.connect.opencodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in DeepInsight.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in DeepInsight.",
  ...
  "dialog.plugins.empty": "Plugins configured in deepinsight.json",
  ...
  "dialog.server.description": "Switch which DeepInsight server this app connects to.",
  ...
  "wsl.onboarding.step.opencode": "DeepInsight",
  ...
  "wsl.onboarding.checkingOpencode": "Checking DeepInsight...",
  "wsl.onboarding.checkingOpencodeIn": "Checking DeepInsight in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating DeepInsight...",
  "wsl.onboarding.updatingOpencodeIn": "Updating DeepInsight in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update DeepInsight in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update DeepInsight",
  "wsl.onboarding.opencodeReadyIn": "DeepInsight is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "DeepInsight is ready.",
  "wsl.onboarding.installOpencodeIn": "Install DeepInsight in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install DeepInsight",
  ...
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen DeepInsight.",
  ...
  "toast.update.description": "A new version of DeepInsight ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the DeepInsight team",
  ...
  "error.chain.checkConfig": "Check your config (deepinsight.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, DeepInsight does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "DeepInsight includes free models so you can start immediately.",
  ...
  "app.name.desktop": "DeepInsight Desktop",
  ...
  "settings.desktop.wsl.description": "Run the DeepInsight server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for DeepInsight",
  ...
  "settings.general.row.appearance.description": "Customise how DeepInsight looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether DeepInsight follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how DeepInsight is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when DeepInsight launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of DeepInsight.",
