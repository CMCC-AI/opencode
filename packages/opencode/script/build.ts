...
const createEmbeddedWebUIBundle = async () => {
  ...
  const appDir = process.env.OPENCODE_WEB_APP_DIR
    ? path.resolve(process.env.OPENCODE_WEB_APP_DIR)
...
if (!skipInstall) {
  await $`bun install --os="*" --cpu="*" @opentui/core@${pkg.dependencies["@opentui/core"]} @opentui/solid@${pkg.dependencies["@opentui/solid"]} @parcel/watcher@${pkg.dependencies["@parcel/watcher"]} @ff-labs/fff-bun@${pkg.dependencies["@ff-labs/fff-bun"]}`
}
