...
const output = resolve(process.argv[3] || resolve(dirname(input), "45-comparison-report.pdf"));
if (!process.argv[2]) throw new Error("用法：node export-report-pdf.mjs <40-comparison-report.html> [45-comparison-report.pdf]");
